...
Or the (not as pretty) output in Markdown
    ...
    #> 11.11% [2019-07-20 23:58:53]: 1 out of 9 (11.11%)
    #> text_id: #efdcxct
    #>  0.96 TOXICITY
    #>  0.79 SEVERE_TOXICITY
    #> 
    #> 22.22% [2019-07-20 23:58:54]: 2 out of 9 (22.22%)
    #> text_id: #ehfcsct
    #>  0.93 TOXICITY
    #>  0.44 SEVERE_TOXICITY
    #> 
    #> 33.33% [2019-07-20 23:58:55]: 3 out of 9 (33.33%)
    #> text_id: #ekacxwt
    #> ERROR
    #> Error in .f(...): HTTP 400
    ...
    #> NO SCORES
    #> 
    #> 44.44% [2019-07-20 23:58:57]: 4 out of 9 (44.44%)
    #> text_id: #ewatxad
    #>  0.06 TOXICITY
    #>  0.02 SEVERE_TOXICITY
    #> 
    #> 55.56% [2019-07-20 23:58:58]: 5 out of 9 (55.56%)
    #> text_id: #ekacswt
    #>  0.67 TOXICITY
    #>  0.31 SEVERE_TOXICITY
    #> 
    #> 66.67% [2019-07-20 23:58:59]: 6 out of 9 (66.67%)
    #> text_id: #ewftxwd
    #>  0.07 TOXICITY
    #>  0.03 SEVERE_TOXICITY
    #> 
    #> 77.78% [2019-07-20 23:59:00]: 7 out of 9 (77.78%)
    #> text_id: #eeadswt
    #> ERROR
    #> Error in .f(...): HTTP 400
    ...
    #> NO SCORES
    #> 
    #> 88.89% [2019-07-20 23:59:01]: 8 out of 9 (88.89%)
    #> text_id: #enfhxed
    #>  0.44 TOXICITY
    #>  0.22 SEVERE_TOXICITY
    #> 
    #> 100.00% [2019-07-20 23:59:02]: 9 out of 9 (100.00%)
    #> text_id: #efdmjd
    #> ERROR
    #> Error in .f(...): HTTP 400
