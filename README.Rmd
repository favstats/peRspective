...
`peRspective` functions will read the API key from environment variable `perspective_api_key`. You can assign the object like this at the start of your script:
#'   
