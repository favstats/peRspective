...
Be sure to check your quota limit! You can find out more about quota limits of the Perspective API by going to [your google cloud project's Perspective API page](https://console.cloud.google.com/apis/api/commentanalyzer.googleapis.com/quotas).
...
You can also use Spanish (`es`) for `TOXICITY` and `SEVERE_TOXICITY` scoring.
...
Finally, there is one last argument: `verbose = TRUE`. Enable this argument and you will receive beautiful terminal output that guides along the way, showing you errors and text scores as you go.
