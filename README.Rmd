...
cat(
	badge_code_size("favstats/peRspective"),
	badge_last_commit("favstats/peRspective")
)
```
...
Next, you can use `prsp_score` to score your comments with various models provided by the Perspective API.
