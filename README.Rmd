...
tibble::tribble(
  ~`Model Attribute Name`,  ~Version,                                  ~`Supported Languages`,   ~`Shourd Description`,
      ...
      "SEVERE_TOXICITY",     "Alpha",                                  "en, es",                  "Same deep-CNN algorithm as TOXICITY, but is trained on 'very toxic' labels.",
      "IDENTITY_ATTACK",     "Experimental toxicity sub-attribute",    "en",                      "negative or hateful comments targeting someone because of their identity.",
    ...
    "SEXUALLY_EXPLICIT",     "Experimental toxicity sub-attribute",    "en",                      "contains references to sexual acts, body parts, or other lewd content.",
...
Instead of just the entire comments you can also score individual sentences with `score_sentences = T`. In this case the Perspective API will automatically split your text into reasonable sentences and score them in addition to an overall score.
